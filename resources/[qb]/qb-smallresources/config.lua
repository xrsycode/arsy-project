...
Config.Discord = {
    ...
    applicationId = '1055884736800755713',                   -- The discord application id
    iconLarge = 'erp',                               -- The name of the large icon
    iconLargeHoverText = 'EVERLIFE Roleplay', -- The hover text of the large icon
